    ...
    return (
        <Container>
            ...
            <TopDiv>
                ...
                <Spacer height="10px" />
                <Row2>
                    <Text color={Theme.colors.primary}><b>{t('Phase 4')}</b><Text2 color='#767676'>&nbsp;{t('- Sowing Soy - 1inch Active Users Airdrop - 500 000 $SOY tokens - 01/12/21 to 15/12/21.')}</Text2></Text>
                </Row2>
                <Spacer height="10px" />
                <Row2>
                ...
                <Spacer height="10px" />
                <Row2>
                    <Text color={Theme.colors.primary}><b>{t('Phase 7')}</b><Text2 color='#767676'>&nbsp;{t('- Harvesting Soy - Details to be published on 25/08/22*.')}</Text2></Text>
                </Row2>
                <Spacer height="10px" />
                <Row2>
                ...
                <Spacer height="40px" />
                <Text color='#767676'>{t('A full description of Soy Tokenomic can be found in the')}<StyledLi href="https://soy-finance.gitbook.io/soy-finance/articles/monetary-policy-vision" target="_blank" color='#615EFF'>&nbsp;{t('SOY Monetary Policy.')}</StyledLi></Text>
                <Spacer height="20px" />
            </TopDiv>
            <Spacer height="100px" />
        </Container>
